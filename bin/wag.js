...
const WAG = (props) => {
    ...
    if ((0, string_1.isStringAndNotEmpty)(configPath) && (0, string_1.isStringAndNotEmpty)(rootUser)) {
        const VAR_APP_USER_ROOT = (0, path_2.pathResolve)(rootUser, 'web-assets-generator');
        const VAR_APP_ROOT = (0, path_2.pathResolve)(path_1.default.dirname(__filename), '../');
        const VAR_APP_LIB_DIR = (0, path_2.pathResolve)(VAR_APP_ROOT, 'bin');
        const VAR_APP_LIB_DIR_SCRIPTS = (0, path_2.pathResolve)(VAR_APP_LIB_DIR, 'scripts');
        const VAR_APP_LIB_DIR_SCRIPTS_ICONS_PACK = (0, path_2.pathResolve)(VAR_APP_LIB_DIR_SCRIPTS, 'icons-pack');
        ...
        const VAR_APP_OUTPUT_PATH_ASSETS_ABSOLUTE = (0, path_2.pathResolve)(VAR_APP_USER_ROOT, VAR_APP_OUTPUT_PATH_ASSETS_RELATIVE);
        const VAR_APP_PLUGINS_TEMP = (0, path_2.pathResolve)(VAR_APP_USER_ROOT, 'temp');
        const VAR_APP_PLUGIN_PWAAG_NAME = 'pwaag';
        const VAR_APP_PLUGIN_PWAAG_IMAGES_EXTENSION = 'png';
        const VAR_APP_PLUGIN_PWAAG_DIR_ROOT = (0, path_2.pathResolve)(VAR_APP_LIB_DIR_SCRIPTS_ICONS_PACK, VAR_APP_PLUGIN_PWAAG_NAME);
        const VAR_APP_PLUGIN_PWAAG_DIR_OUTPUT = (0, path_2.pathResolve)(VAR_APP_PLUGINS_TEMP, VAR_APP_PLUGIN_PWAAG_NAME);
        ...
        const VAR_APP_PLUGIN_REALFAVICON_DIR_ROOT = (0, path_2.pathResolve)(VAR_APP_LIB_DIR_SCRIPTS_ICONS_PACK, VAR_APP_PLUGIN_REALFAVICON_NAME);
        const VAR_APP_PLUGIN_REALFAVICON_DIR_OUTPUT = (0, path_2.pathResolve)(VAR_APP_PLUGINS_TEMP, VAR_APP_PLUGIN_REALFAVICON_NAME);
        ...
        const CTX_BASE = {
            ...
            paths: {
                indexHtml: (0, path_2.pathResolve)(VAR_APP_USER_ROOT, VAR_APP_FILE_NAME_HTML_INDEX),
                outputLib: VAR_APP_USER_ROOT,
                outputLibAssets: VAR_APP_OUTPUT_PATH_ASSETS_ABSOLUTE,
                outputLibAssetsImages: (0, path_2.pathResolve)(VAR_APP_USER_ROOT, VAR_APP_OUTPUT_PATH_ASSETS_IMAGES_RELATIVE),
            ...
            plugins: {
                pwaag: {
                    ...
                    paths: {
                        indexHtml: (0, path_2.pathResolve)(VAR_APP_PLUGIN_PWAAG_DIR_OUTPUT, 'index.html'),
                ...
                realfavicon: {
                    ...
                    paths: {
                        config: (0, path_2.pathResolve)(VAR_APP_PLUGIN_REALFAVICON_DIR_OUTPUT, 'config.json'),
                        indexHtml: (0, path_2.pathResolve)(VAR_APP_PLUGIN_REALFAVICON_DIR_OUTPUT, VAR_APP_PLUGIN_REALFAVICON_HTML_INDEX),
                        output: VAR_APP_PLUGIN_REALFAVICON_DIR_OUTPUT,
                        outputDataFile: (0, path_2.pathResolve)(VAR_APP_PLUGIN_REALFAVICON_DIR_OUTPUT, 'data.json'),
                        override: VAR_APP_OUTPUT_PATH_ASSETS_IMAGES_RELATIVE,
